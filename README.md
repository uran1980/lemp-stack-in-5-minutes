...
Если коротко, то **[Chef](http://wiki.opscode.com/display/chef/About+Opscode+Chef)** это опенсорсный фреймворк разработанный специально для автоматизации развертывания различных окружений в облаке. Как заверяют разработчики: "Не важно насколько сложна инфраструктура вашего бизнеса, **Chef** позволяет очень просто и быстро развернуть все необходимые сервера и приложения необходимые для его полноценной работы".
