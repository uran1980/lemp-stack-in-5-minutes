...
* **[Chef-server](http://wiki.opscode.com/display/chef/About+Opscode+Chef)** - cреда автоматизированного развертывания окружений
* Набор необходимых рецептов _(chef cookbooks)_ для приготовления LEMP-стека (их вы найдете в моем репозитарии к этой статье).
